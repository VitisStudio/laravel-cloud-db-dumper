...
class TestCase extends Orchestra
{
    protected function setUp(): void
    {
        ...
        //
        // Off, including on Windows: Prompt::prompt() returns the default for a
        // non-interactive prompt before it ever checks the platform, so tests
        // exercise the real path. Only a test driving a faked keyboard needs
        // interactivity, and there is no such thing on Windows to drive.
